...
import com.manifestai.app.model.ManifestCategory
        ...
        Column(
            ...
            Row(
                ...
                StatCard(
                    ...
                    label    = "Actions done",
                    value    = "${viewModel.completedActionsCount()} / ${viewModel.totalActionsCount()}",
                    color    = AuroraMint,
                )
                StatCard(
                    modifier = Modifier.weight(1f),
                    label    = "Alignment score",
                    value    = "${state.alignmentScore.total}",
                    color    = CosmicPurple,
                )
            }
...
// ── Manifestation card (carousel item) ───────────────────────────────────────

@Composable
private fun ManifestCard(m: com.manifestai.app.model.Manifestation) {
