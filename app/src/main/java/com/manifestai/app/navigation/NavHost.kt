...
fun ManifestAINavHost(
    ...
    NavHost(navController = navController, startDestination = start) {
        ...
        composable(Screen.ActionEngine.route) {
            ActionEngineScreen(viewModel = viewModel, onBack = { navController.popBackStack() })
        }
        composable(Screen.Habits.route) {
            HabitsScreen(viewModel = viewModel, onBack = { navController.popBackStack() })
        }
        composable(Screen.Alignment.route) {
            AlignmentScreen(viewModel = viewModel, onBack = { navController.popBackStack() })
        }
        composable(Screen.Journal.route) {
            JournalScreen(viewModel = viewModel, onBack = { navController.popBackStack() })
        }
    }
}
